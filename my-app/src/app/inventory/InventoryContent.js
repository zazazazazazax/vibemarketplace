...
const isZoomed = zoomedLabels[cacheKey];
                      return (
                        <div
                          key={index}
                          className={`group relative rounded-lg shadow-lg cursor-pointer transition-all duration-300 overflow-hidden w-80 mx-0 -ml-4 sm:mx-auto h-[30.375rem] ${multiMode && isSelected ? 'scale-105' : ''}`}
